...
<script>
  ...
  import * as re_commend from '../../network/manage/commend_list.js'
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        re_commend.getCommendList().then(res => {
      ...
      deleteMore() {
        ...
        this.$confirm('此操作将批量永久删除所选评论, 是否继续?', '提示', {
          ...
          .then(() => {
            re_commend.deleteMoreCommend(deleteList).then(res => {
                console.log(res.data)
                this.$message({
                  type: 'success',
                  message: '删除成功!'
      ...
      del(row) {
        ...
        this.$confirm('此操作将删除此评论, 是否继续?', '提示', {
          ...
          .then(() => {
            re_commend.delCommend(row.id).then(res => {
                console.log(res.data)
                this.$message({
                  type: 'success',
                  message: '删除成功!'
